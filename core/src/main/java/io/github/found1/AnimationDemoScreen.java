...
public class AnimationDemoScreen implements Screen {
    ...
    private Animation<TextureRegion> slimAnim, coinAnim;
    ...
    public void render(float delta) {
        ...
        switch (state) {
            ...
            case RUNNING -> currentAnim = runAnim;
            case JUMPING -> currentAnim = jumpAnim;
        ...
        TextureRegion slimeFrame = slimAnim.getKeyFrame(stateTime, true);
